...
public final class Constants {
    ...
    public static final class CoralHandConstants {
        public static final int kCoralHandCanID = 17;
    ...
    public static final class CoralShoulderConstants {
        public static final int kCoralShoulderCanID = 10;
        public static final double kGearRatio = ( 54.0 / 22.0);
        public static final double kCoralShoulderCruiseVelocityRPM = 6000.0;
        public static final double kCoralShoulderAccelerationRPM = 500.0;
        ...
        // public static final double kCoralShoulderTargetAngle = -160.0; // degrees
    }

    public static final class ElevatorConstants {
        public static final int kElevatorCanID = 16;
        public static final double kElevatorCruiseVelocityRPM = 6000.0;
        public static final double kElevatorAccelerationRPM = 12000.0;
        ...
        public static final double kElevatorDistancePerMotorRevolution = 3.1415927 * 1.751 /16.0; // Inches
        // public static final double kElevatorTargetDistance = -10.0; // Inches
    }
}

...
public final class Constants {
    ...
    public static final class CoralShoulderConstants {
        public static final int kCoralShoulderCanID = 10; // 10
        // public static final double kGearRatio = (54.0 / 22.0) / 9.0;
        public static final double kGearRatio = 5.0/1.0;
        public static final double kCoralShoulderCruiseVelocityRPM = 200.0;
        public static final double kCoralShoulderAccelerationRPM = 120.0;
        public static final double kCoralShoulderkP =10.0; // Placeholder, tune accordingly
        ...
        public static final double kCoralShoulderkV = 0.0; // Placeholder, tune accordingly
    }

    public static final class ElevatorConstants {
        public static final int kElevatorCanID = 16;  // 16
        ...
        public static final double kElevatorkP = 80.0; // Placeholder, tune accordingly
        ...
        public static final double kElevatorDistancePerMotorRevolution = 1.0/2.0;  //3.1415927 * 1.751 / 16.0; // Inches  
